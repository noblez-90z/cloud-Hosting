  ...
  return (
    <div className="bg-[#000] text-white mt-20 h-fit py-16 md:px-5">
      <div className="container mt-20 md:mt-0 md:h-[400px] flex justify-center items-center md:px-3">
        ...
        <div className="illustration flex-1  flex justify-center py-8">
          {" "}
      ...
      <div className="w-full my-6 py-6">
        <div className="container">
          <div className="flex items-center justify-center gap-6  my-6 py-6 md:px-6 px-4 ">
            ...
            <div className="fact-feature  flex items-center gap-2">
      ...
      <div className="container py-4">
        ...
        <div className="row flex justify-around mt-6 py-3">
          <div className="">
